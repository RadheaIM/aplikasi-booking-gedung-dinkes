<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        {{-- Menggunakan logo yang sudah diubah (Ikon Kunci + Teks BOOKING) --}}
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    {{-- === LINK BARU: LAPORAN BULANAN (Hanya untuk Admin) === --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- === LINK BARU RESPONSIVE: LAPORAN BULANAN (Hanya untuk Admin) === --}}
            @if (Auth::user()->name === 'Admin Dinas' || Auth::user()->id === 1)
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                {{-- Link Profile Responsive dinonaktifkan --}}
                {{--
